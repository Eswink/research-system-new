...
| 4 | PLAN-20260920-124（EC-04） | 见回合汇报（derive + ALL_PLAN 投影） | （执行中） | 见回合汇报（**未跑到终态不记账**） | — | EC-04 PENDING（本轮只完成 derive）；EC-05/EC-06 PENDING | 继续 PLAN-20260920-124 的 WP1…WP5 |
...
| cycle 4 derive | 见回合汇报（**台账尾巴口径**：本条自身触发的 run 不再回写文件） | |
