...
const ALL_ROUTES: readonly { name: string; hash: string; testid: string }[] = [
  ...
  { name: "library-prompts", hash: "#/library/prompts", testid: "example-page-library-prompts" },
  { name: "library-datasets", hash: "#/library/datasets", testid: "example-page-library-datasets" },
  {
    name: "library-notebooks",
    hash: "#/library/notebooks",
    testid: "example-page-library-notebooks",
  },
  ...
  { name: "insights-reports", hash: "#/insights/reports", testid: "example-page-insights-reports" },
  ...
  { name: "ops-integrations", hash: "#/ops/integrations", testid: "example-page-ops-integrations" },
