...
const ALL_ROUTES: readonly { name: string; hash: string; testid: string }[] = [
  ...
  { name: "plan-team", hash: "#/plan/team", testid: "team-page" },
  {
    ...
    testid: "gap-page-portfolio-projects",
  },
  ...
  { name: "library-prompts", hash: "#/library/prompts", testid: "gap-page-library-prompts" },
  { name: "library-datasets", hash: "#/library/datasets", testid: "gap-page-library-datasets" },
  { name: "library-notebooks", hash: "#/library/notebooks", testid: "gap-page-library-notebooks" },
  ...
  { name: "insights-reports", hash: "#/insights/reports", testid: "gap-page-insights-reports" },
  { name: "insights-cost-analytics", hash: "#/insights/cost-analytics", testid: "console-main" },
  { name: "ops-alerts", hash: "#/ops/alerts", testid: "gap-page-ops-alerts" },
  { name: "ops-incidents", hash: "#/ops/incidents", testid: "gap-page-ops-incidents" },
  { name: "ops-schedules", hash: "#/ops/schedules", testid: "gap-page-ops-schedules" },
  { name: "ops-integrations", hash: "#/ops/integrations", testid: "gap-page-ops-integrations" },
  { name: "ops-data-health", hash: "#/ops/data-health", testid: "gap-page-ops-data-health" },
  { name: "ops-matrix", hash: "#/ops/matrix", testid: "gap-page-ops-matrix" },
  ...
  { name: "settings", hash: "#/settings/settings", testid: "console-main" },
  {
    ...
    testid: "gap-page-notifications-notifications",
  },
