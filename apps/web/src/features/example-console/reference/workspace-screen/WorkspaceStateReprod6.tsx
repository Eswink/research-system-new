...
interface WorkspaceStateReprod6Props {
  exp:
    | {
...
export function WorkspaceStateReprod6({ exp, t }: WorkspaceStateReprod6Props) {
  return (
    <div className={visual.row4}>
      <Icon name="flask" size={12} className={visual.surface11} />
      <span className={visual.label7}>{exp.label}</span>
