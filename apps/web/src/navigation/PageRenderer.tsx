...
const REAL_PAGES: Readonly<Record<string, PageFactory>> = {
  ...
  "plan/protocol": () => <ProtocolDraftEditor />,
  "plan/team": () => <TeamPage />,
  ...
  "run/workspace": () => <WorkspaceView />,
  "evidence/claims": () => <InspectionPanel />,
  ...
  "ops/observability": () => <OperationsPanel />,
};
...
export function PageRenderer({ route, ctx }: { route: Route; ctx: PageContext }): ReactNode {
  ...
  if (factory !== undefined) {
    return factory(route, ctx);
  }
  return <GapPage route={route} support={pageSupport(route)} />;
}
