...
export const GAPS = {
  ...
  integrations:
    ...
    "ToolPack 供应链已可操作（GET /tool-packs + install/approve-update/revoke：" +
    "digest 由控制面重算自证、权限扩张须批准才生效——待批准版本在横幅里、表中" +
    "digest 始终是生效版本、REVOKE 终态）；缺：provider 凭据绑定、" +
    "健康复核的 schema digest 漂移比对",
  dataHealth:
