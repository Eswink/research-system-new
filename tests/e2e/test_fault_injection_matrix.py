...
F-09..F-12（policy denied / cancellation / malformed / evaluator rejection）
见 test_fault_injection_gates.py。F-03/F-04（ToolProvider failure/timeout）：
